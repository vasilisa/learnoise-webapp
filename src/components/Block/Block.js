    ...
    { 
      ...
      if (this.state.currentInstructionText===1) {
        text = <div className='textbox'> 
            ...
            text = <div className='textbox'>
            <p>Additionally, we will also ask you how confident you are in your decision on a scale from "Very uncertain" to "Very certain"</p>
            <div className="translate"/>
            
            <img className="introconf"  src={require('../../images/conf_intro.png')} alt='introconf'/> 
            <p><span className = 'bold'>Very uncertain</span> indicates that you are very unsure that you chose the option which is <span className='bold'> currently the most rewarding</span>.</p>
            <p><span className = 'bold'>Very certain</span>  indivates that you are very sure that you chose the option which is <span className='bold'> currently the most rewarding</span>.</p> 
